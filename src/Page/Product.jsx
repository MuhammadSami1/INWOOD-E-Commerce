            ...
            <div key={item.id} className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mb-4">
                  <span className="flex items-center">
                    <svg
                      ...
                      strokeWidth="2"
                      className="w-4 h-4 text-CustomColor1"
                      viewBox="0 0 24 24"
                    >
                ...
                <div className="flex">
                  ...
                  <button
                    className="flex ml-auto text-white bg-CustomColor1 border-0 py-2 px-2 sm:px-6 focus:outline-none hover:bg-opacity-70 rounded-md"
